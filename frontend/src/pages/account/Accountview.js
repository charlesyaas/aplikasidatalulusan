...
const AkunAccountviewPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
			<div>
<main id="AkunAccountviewPage" className="main-page">
...
AkunAccountviewPage.defaultProps = {
	id: null,
	primaryKey: 'id',
	pageName: 'akun',
	apiPath: 'account',
	routeName: 'akunaccountview',
...
export default AkunAccountviewPage;
