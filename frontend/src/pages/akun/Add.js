...
const AkunAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="AkunAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Add New Akun"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div className="grid">
                                    ...
                                    <div className="col-12">
                                        <div className="formgrid grid">
                                            ...
                                            <div className="col-12 md:col-9">
                                                <CheckDuplicate value={formik.values.email} apiPath="components_data/akun_email_exist">
                                                { (checker) => 
                                                <>
