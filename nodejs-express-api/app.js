...
import AkunController from  './controllers/akun.js';
import PesertaController from  './controllers/peserta.js';
...
app.use('/api/akun', AkunController);
app.use('/api/peserta', PesertaController);
