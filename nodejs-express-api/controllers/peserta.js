...
router.get(['/', '/index/:fieldname?/:fieldvalue?'], async (req, res) => {  
	try{
		...
		if(req.query.tahun_lulus){
			queryFilters.push(DB.filterBy("peserta.tahun_lulus", req.query.tahun_lulus))
		}
		if(req.query.jenjang){
			queryFilters.push(DB.filterBy("peserta.jenjang", req.query.jenjang))
		}
...
router.post('/add/', 
	[
		...
		body('tahun_lulus').optional({nullable: true, checkFalsy: true}).isNumeric(),
		...
		body('npsn').optional({nullable: true, checkFalsy: true}).isNumeric(),
		body('asal_sekolah').optional({nullable: true, checkFalsy: true}),
	], validateFormData
